...
//         style.normal.background = EditorGUIHelper.MakeBackgroundTexture(1, 1, property.isExpanded ? Color.yellow : Color.yellow * 0.8f);
...
//             var not = conditionBinder.FindPropertyRelative("Not").boolValue;
