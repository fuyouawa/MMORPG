...
namespace GraphProcessor
{
    ...
    public class ExposedParameterDrawer : PropertyDrawer
    {
        ...
        protected VisualElement CreateValProperty(SerializedProperty property, string displayName = null)
        {
            ...
            var valProperty = GetValProperty(property);
            var p = new PropertyField(valProperty, displayName);

            valProperty.RegisterValueChangedCallback2019(e => {
    ...
    public class ExposedParameterSettingsDrawer : PropertyDrawer
    {
        ...
        protected VisualElement CreateHideInInspectorField(SerializedProperty settingsProperty)
        {
            ...
            isHidden.RegisterValueChangedCallback2019(e => {
        ...
        protected static PropertyField CreateSettingsField(SerializedProperty settingsProperty, string fieldName, string displayName = null,Action<SerializedProperty> onCallback =null)
        {
            ...
            prop.RegisterValueChangedCallback2019(e => {
                settingsProperty.serializedObject.ApplyModifiedProperties();
                graph.NotifyExposedParameterChanged(param);
            });
            
            onCallback?.Invoke(prop);
    ...
    public class FloatSettingsDrawer : ExposedParameterSettingsDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty settingsProperty)
        {
            ...
            var mode = CreateSettingsField(settingsProperty, nameof(FloatParameter.FloatSettings.mode), "Mode", modeS =>
            {
                modeS.RegisterValueChangedCallback2019(e =>
                {
                    UpdateVisibility(e);
                });
            });
    ...
    public class IntSettingsDrawer : ExposedParameterSettingsDrawer
    {
        public override VisualElement CreatePropertyGUI(SerializedProperty settingsProperty)
        {
            ...
            var mode = CreateSettingsField(settingsProperty, nameof(IntParameter.IntSettings.mode), "Mode", modes =>
            {
                modes.RegisterValueChangedCallback2019(e =>
                {
                    UpdateVisibility(e);
