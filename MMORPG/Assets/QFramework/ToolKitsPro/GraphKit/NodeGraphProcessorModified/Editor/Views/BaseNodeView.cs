...
namespace GraphProcessor
{
	...
	public class BaseNodeView : NodeView
	{
		...
		protected VisualElement AddControlField(FieldInfo field, string label = null, bool showInputDrawer = false, Action valueChangedCallback = null)
		{
			...
			var fieldNameProperty = FindSerializedProperty(field.Name);
			var element = new PropertyField(fieldNameProperty, showInputDrawer ? "" : label);
			...
			fieldNameProperty.RegisterValueChangedCallback2019(e => {
